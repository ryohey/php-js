/*
 * The benchmark's React component tree, written in ES5 with React.createElement
 * directly so no JSX build step sits between the source and what the engine
 * runs. Deliberately free of any ReactDOMServer import: the two entry points
 * beside it reach the renderer by different specifiers (see app.js).
 */
'use strict';
...
exports.element = function (itemCount, runtime) {
  return e(App, { title: 'php-js SSR', items: buildItems(itemCount), runtime: runtime, year: 2026 });
};
